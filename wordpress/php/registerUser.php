...
$add_member->bindParam(":username", $username);
$add_member->bindParam(":fname", $first_name);
$add_member->bindParam(":lname", $last_name);
$add_member->bindParam(":pass", $password1);
$add_member->bindParam(":email", $email);
$add_member->bindParam(":date", $date);
$add_member->bindParam(":ip_address", $ip_address);
$add_member->bindParam(":act", $activation_code);
$add_member->bindParam(":cancel", $cancel_code);
$add_member->execute();
...
$userMsg =
"
Hey " . ucfirst($first_name) ." ". ucfirst($last_name) . ",
<br />
...
<br />
<a href='localhost/silent-investments/emailActivation.php?activate=" . $activation_code . "&email=" . $email ."'>Click here to activate your account</a>
<br />

<br />
If the above link does not work, type or copy and paste the link below into the url address of your browser:
<br />
/confirm_activation_link.php?activate=" . $activation_code . "&email=" . $email ."
...
// You are now signed up! Please check your email and junk mail
